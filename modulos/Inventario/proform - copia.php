...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($accion === 'guardar_basico') {
        // Helpers numéricos simples (acepta "100,50")
        ...
        // Los precios posteados se recalculan abajo
        ...
        // Recalcular precios en el servidor con el % real del impuesto
        if (empty($errores)) {
            try {
                ...
                $precio_venta = $precio_minorista; // por defecto igual al minorista
            } catch (PDOException $e) {
...
// Mantenemos 2 decimales. Precio de Venta = Precio Minorista.
(function(){
  ...
  if (!selImpuesto) return; // estamos en paso proveedores
  ...
  function calc() {
    ...
    const iva = porcImpuesto(); // 21 -> 1.21
