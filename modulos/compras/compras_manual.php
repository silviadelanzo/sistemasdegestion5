...
// Generar próximo código de remito
try {
    $sql_codigo = "SELECT codigo FROM compras WHERE codigo LIKE 'REMI-%' ORDER BY CAST(SUBSTRING(codigo, 6) AS UNSIGNED) DESC LIMIT 1";
    ...
    $nuevo_codigo = 'REMI-' . str_pad($numero, 7, '0', STR_PAD_LEFT);
} catch (Exception $e) {
    $nuevo_codigo = 'REMI-0000001';
}
?>
<!DOCTYPE html>
<html lang="es">
        ...
        <div class="main-card">
            ...
            <form id="formCompraManual" method="POST" action="procesar_compra_manual.php">
                ...
                <div class="footer-actions">
                    <div>
                        <button type="button" class="btn btn-secondary btn-custom" onclick="window.location.href='compras_form.php'">
                            <i class="fas fa-arrow-left"></i> Volver al Selector
                        </button>
