...
<nav class="navbar navbar-expand-lg navbar-custom sticky-top">
    ...
    <li><a class="dropdown-item" href="<?php echo $base_path; ?>compras/ocom_form.php"><i class="bi bi-file-earmark-plus me-2"></i>+ Orden de Compra</a></li>
    <li><a class="dropdown-item" href="<?php echo $base_path; ?>compras/ocom_listado.php"><i class="bi bi-list-check me-2"></i>Ver O. Compra</a></li>

    <li>
    <hr class="dropdown-divider">
    </li>
    <li><a class="dropdown-item" href="<?php echo $base_path; ?>compras/remitos.php"><i class="bi bi-file-earmark-text me-2"></i>Ver Remitos</a></li>
    <li><a class="dropdown-item" href="<?php echo $base_path; ?>compras/remito_nuevo.php"><i class="bi bi-plus-circle me-2"></i>+ Nuevo Remito</a></li>

    <li>
    <hr class="dropdown-divider">
    </li>
    <li><a class="dropdown-item" href="<?php echo $base_path; ?>compras/proveedores.php"><i class="bi bi-building me-2"></i>Proveedores</a></li>
    <li><a class="dropdown-item" href="<?php echo $base_path; ?>compras/recepcion_mercaderia.php"><i class="bi bi-box-arrow-in-down me-2"></i>Recepción</a></li>
    <li>
    <hr class="dropdown-divider">
    </li>
    <li><a class="dropdown-item" href="<?php echo $base_path; ?>compras/reportes_compras.php"><i class="bi bi-graph-up me-2"></i>Reportes</a></li>
    </ul>
    </li>
    <!-- Menú Productos -->
    <li class="nav-item dropdown">
