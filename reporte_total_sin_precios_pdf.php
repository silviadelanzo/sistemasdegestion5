...
try {
    ...
    // Obtener totales generales (sin valores monetarios)
    $sql_totales = "SELECT 
    ...
    // Obtener todos los productos sin precios
    ...
    // Estadísticas de stock (sin valores monetarios)
    $sql_stats = "SELECT 
...
<head>
    ...
    <title>Reporte de Inventario Sin Precios - PDF</title>
    <style>
...
<body>
    <div class="container">
        <div class="print-buttons">
            <h3>📊 Reporte de Inventario Sin Precios - Exportación PDF</h3>
            <p>Este reporte incluye todos los productos sin información de precios</p>
        ...
        <div class="report-header">
            <h1>📊 REPORTE DE INVENTARIO - SIN PRECIOS</h1>
                        ...
                        <?php foreach ($productos as $producto): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="stock-<?php echo strtolower(str_replace(' ', '', $producto['estado_stock'])); ?>">
