...
<worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships">
    ...
    $worksheet1 .= '<c r="' . getExcelCoord($fila_num - 1, 8) . '" s="5"><v>' . $total_general . '</v></c>';
    $worksheet1 .= '</row>';
...
<worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships">
    ...
    <mergeCells count="2">
        <mergeCell ref="A1:D1"/>
        <mergeCell ref="A' . (6 + count($analisis_categorias)) . ':D' . (6 + count($analisis_categorias)) . '"/>
    </mergeCells>
    <sheetData>';
    ...
    $worksheet2 .= '<c r="D' . $fila . '" s="5"><v>' . $total_cat_valor . '</v></c>';
    $worksheet2 .= '</row>';
    $fila++;
    ...
    $worksheet2 .= '<c r="D' . $fila . '" s="5"><v>' . $total_lug_valor . '</v></c>';
    $worksheet2 .= '</row>';
